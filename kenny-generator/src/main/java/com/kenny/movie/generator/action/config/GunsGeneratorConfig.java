package com.kenny.movie.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/movie?characterEncoding=utf8");
    }
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.kenny.movie.admin.common.persistence.model");
        packageConfig.setMapper("com.kenny.movie.admin.common.persistence.dao");
        packageConfig.setXml("com.kenny.movie.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.kenny.movie.admin");
        contextConfig.setCoreBasePackage("com.kenny.movie.core");
