...
public class ContextConfig {
    ...
    private String proPackage = "com.kenny.movie.admin";
    private String coreBasePackage = "com.kenny.movie.core";
    private String modelPackageName = "com.kenny.movie.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.kenny.movie.modular.system.dao";    //model的dao
