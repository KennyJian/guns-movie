package com.kenny.movie.generator.engine.config;
...
public class ControllerConfig {
    ...
    public void init() {
        ...
        imports.add("com.kenny.movie.core.common.annotion.Permission");
        imports.add("com.kenny.movie.core.common.exception.BizExceptionEnum");
        imports.add("com.kenny.movie.core.exception.GunsException");
        imports.add("org.springframework.validation.BindingResult");
        imports.add("javax.validation.Valid");
        imports.add("com.kenny.movie.core.shiro.ShiroKit");
        imports.add("com.kenny.movie.core.util.ToolUtil");
