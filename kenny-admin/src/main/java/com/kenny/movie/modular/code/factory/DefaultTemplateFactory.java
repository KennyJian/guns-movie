package com.kenny.movie.modular.code.factory;


import com.kenny.movie.MovieApplication;
import com.kenny.movie.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setProjectPackage(MovieApplication.class.getPackage().getName());
